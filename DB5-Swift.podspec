...
Pod::Spec.new do |s|
  ...
  s.homepage     = "http://github.com/mwermuth/DB5-Swift"
  ...
  # Or just: s.author    = "Marcus"
  # s.authors            = { "Marcus" => "marcus@mwermuth.com" }
  # s.social_media_url   = "http://twitter.com/Marcus"
  ...
  s.source       = { :git => "http://github.com/mwermuth/DB5-Swift.git", :tag => "0.0.1" }
